...
import com.eguide.yash1300.e_guide.fragments.teacher.TeacherHomeProjectsFragment;
...
public class TeacherHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AHBottomNavigationItem projects = new AHBottomNavigationItem("Projects", R.drawable.ic_person_outline_black_24dp, R.color.white);
        ...
        ahBottomNavigation.addItem(projects);
            ...
            public boolean onTabSelected(int position, boolean wasSelected) {
                switch(position) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        Fragment projectFrag = new TeacherHomeProjectsFragment(TeacherHomeActivity.this, token);
                        loadFragment(projectFrag);
                        break;
                    case 3:
